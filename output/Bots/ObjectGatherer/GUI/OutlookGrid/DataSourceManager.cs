...
namespace ObjectGatherer.GUI.OutlookGrid {
    ...
    internal class DataSourceRow : CollectionBase {
        ...
        public DataSourceManager Manager { get; set; }
    ...
    internal class DataSourceManager {
        ...
        private void InitDataSet() {
            ...
            var table = ((DataSet)_dataSource).Tables[_dataMember];
        ...
        private void InitList() {
            ...
            // use reflection to discover all properties of the object
            const BindingFlags bf = BindingFlags.Instance | BindingFlags.Public | BindingFlags.GetProperty;
