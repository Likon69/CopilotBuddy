...
namespace ObjectGatherer.GUI.OutlookGrid {
    ...
    public class OutlookgGridDefaultGroup : IOutlookGridGroup {
        ...
        public virtual string Text {
            get {
                return column == null ? string.Format("Unbound group: {0} ({1})", Value, itemCount == 1 ? "1 item" : itemCount + " items") : string.Format("{0}: {1} ({2})", column.HeaderText, Value, itemCount == 1 ? "1 item" : itemCount + " items");
            }
            set { text = value; }
        }
        ...
        public virtual int CompareTo(object obj) {
            return String.CompareOrdinal(val.ToString(), obj.ToString());
        }
    ...
    public class OutlookGridAlphabeticGroup : OutlookgGridDefaultGroup {
        public override string Text {
            get {
                return string.Format("Alphabetic: {0} ({1})", Value, itemCount == 1 ? "1 item" : itemCount + " items");
            }
            set { text = value; }
        }
        ...
        public override int CompareTo(object obj) {
            return String.CompareOrdinal(val.ToString(), obj.ToString().Substring(0, 1).ToUpper());
        }
