...
namespace ObjectGatherer.GUI.OutlookGrid {
    ...
    public class OutlookGridRow : DataGridViewRow {
        ...
        protected override void Paint(Graphics graphics, Rectangle clipBounds, Rectangle rowBounds, int rowIndex, DataGridViewElementStates rowState, bool isFirstDisplayedRow, bool isLastVisibleRow) {
            if(_isGroupRow) {
                ...
                graphics.DrawString(_group.Text, grid.Font, Brushes.Lime,
                    rowHeadersWidth - grid.HorizontalScrollingOffset + 23, rowBounds.Bottom - 24);
    ...
    internal class OutlookGridRowComparer : IComparer {
        ...
        public int Compare(object x, object y) {
            ...
            return System.String.CompareOrdinal(obj1.Cells[_columnIndex].Value.ToString(), obj2.Cells[_columnIndex].Value.ToString()) * (_direction == ListSortDirection.Ascending ? 1 : -1);
        }
        #endregion
    }
